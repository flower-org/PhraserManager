...
Для шифровки используется AES-256 CBC, таким образом размер закриптованны данных 4096-16 = 4080 байт, 
...
В футере криптованного сегмента у нас: 2 (Adler16) = 2 байта.
Таким образом, максимальный размер данных 4080 - (2+3) = 4075 байт.
